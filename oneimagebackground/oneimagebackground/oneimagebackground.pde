...
void setup() {
  //CANVAS
  size (750, 600); //Landscape
  //
  //Population of Image
  pic = loadImage("../Images Used/image1.jpg"); //Dimensions: width 800, height 600
  //Note: Dimensions are found in the image file / Right Click / Properties / Details
  //Alogrithm: Find the larger dimension for aspect ration (comparison of two numbers)
  int picWidth = 400; //Mine is 800, do not copy this!!!
  int picHeight = 200; //Mine is 600, do not copy this!!!
  //
